...
const rows = [
  createData('Ashna-basics'	,'Unlimited','Unlimited','Unlimited','Unlimited','Unlimited'),
  createData('Ashna-o1'	,'Limited	Up to 5x', 'Free','Unlimited','Expanded','Expanded'),
  createData('Ashna-X1',<RemoveIcon/>	,'Standard','Unlimited',	'Expanded','Expanded'),
  createData('Response Times','Limited','Fast','Fast','Fast','Fastest'),
  createData('Context Window','8K','32K','128K','32K','128K'),
...
export default function Table4() {
  return (
    <div className="mt-10 p-8">
      <h1 className="text-4xl font-bold text-center mb-10 font-barlow">Model Quality</h1>
