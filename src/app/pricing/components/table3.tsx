...
const rows = [
  createData('Advanced Voice with Video',<RemoveIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>),
  createData('File Uploads','Limited',<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>),
  createData('Search'	,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>),
  createData('Custom GPTs',<RemoveIcon/>,<RemoveIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>),
  createData('Image Generation','Limited',<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>),
  createData('Deep Research',<RemoveIcon/>,<RemoveIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>,<DoneOutlinedIcon/>),
];

export default function Table3() {
  return (
    <div className="mt-10 p-8">
      <h1 className="text-4xl font-bold text-center mb-10 font-barlow">Features</h1>
